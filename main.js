...
// Tắt máy chủ nếu phát hiện nhiều yêu cầu từ cùng một
...
app.get('/css/style-api.css', function(req, res) {
   res.sendFile(__dirname + '/css/style-api.css');

})
app.get('/css/style-switcher.css', function(req, res) {
   res.sendFile(__dirname + '/css/style-switcher.css');
...
app.get('/js/style-switcher.js', function(req, res) {
   res.sendFile(__dirname + '/js/style-switcher.js');

})
app.get('/js/typed.min.js', function(req, res) {
   res.sendFile(__dirname + '/js/typed.min.js');

})
app.get('/js/getIP.js', function(req, res) {
   res.sendFile(__dirname + '/js/getIP.js');

})
app.get('/css/business-card.js', function(req, res) {
   res.sendFile(__dirname + '/css/business-card.js');

})
app.get('/image/logo.png', function(req, res) {
   res.sendFile(__dirname + '/image/logo.png');

})
app.get('/tool.js', function(req, res) {
   res.sendFile(__dirname + '/tool.js');
...
app.get('/', function(req, res) {
   res.sendFile(__dirname + '/index.html');
    ...
    console.log('\x1b[36m=====================================================\n\x1b[38;5;220m[ START ] \x1b[33m→\x1b[38;5;119m Máy chủ KAIYOAPI đang chạy trên PORT\x1b[38;5;208m', app.get('port'), '\n\x1b[36m=====================================================\n');
});
